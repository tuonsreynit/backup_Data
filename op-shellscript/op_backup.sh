...
HOME2="/home/tuonsreynit/Desktop/Docker/op-shellscript"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
BACKUP_DIR="$HOME2/op_backups"
FOLDERS=("assets" "pgdata" )  # Add folder paths
ZIP_FILE="backup_op_${TIMESTAMP}.zip"
...
pwd
zip -r "${BACKUP_DIR}/${ZIP_FILE}" "${FOLDERS[@]}"
if [ $? -ne 0 ]; then
